...
function Preference() {
  ...
  return (
    <form
      ...
      onSubmit={handleUpdatePreferenceprofile}
    >
        ...
        <div className="grid grid-cols-2  gap-4">
          ...
          <div>
            ...
            <textarea
              name="Requirements"
              value={
                formChanges.Requirements || profileData?.Requirements || ""
              }
              onChange={handleInputChange}
              className="mt-1 block w-full border border-gray-300 rounded-md p-2 h-32"
            />
          ...
          <div>
            ...
            <textarea
              name="family_detail"
              value={
                formChanges.family_detail || profileData?.family_detail || ""
              }
              onChange={handleInputChange}
              className="mt-1 block w-full border border-gray-300 rounded-md p-2 h-32"
            />
          ...
          <div>
            ...
            <input
              ...
              value={
                formChanges.Native_Hometown ||
                profileData?.Native_Hometown ||
                ""
              }
              onChange={handleInputChange}
              type="text"
            ...
            <Select
              name="Current_city"
              value={
                formChanges.Current_city
                  ? {
                      value: formChanges.Current_city,
                      label: formChanges.Current_city,
                    }
                  : profileData?.Current_city
                  ? {
                      value: profileData.Current_city,
                      label: profileData.Current_city,
                    }
                  : null
              }
              ...
              onChange={(option) =>
                handleSelectChange("Current_city", option.value)
              }
            />
          </div>
        </div>
