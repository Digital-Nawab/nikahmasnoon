  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        ...
        variant="small"
        color="blue-gray"
        className="p-1 text-white text-base hover:text-green-900 font-semibold tracking-wide"
      >
        <Link
          to="/"
          className="flex items-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100"
        >
          Home
        </Link>
      </Typography>
      ...
      <Typography
        ...
        variant="small"
        color="blue-gray"
        className="p-1 text-white hover:text-green-900 text-base font-semibold tracking-wide"
      >
        <Link
          to="/contact"
          className="flex items-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100"
    ...
    <>
      <div className="fixed w-full top-0 left-0 r-0 z-[200]">
              ...
              <div className="flex items-center justify-between text-blue-gray-900">
                ...
                <Typography className="cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                  <Link to="/">
                    <img
                      width={300}
                      src="https://nikahmasnoon.com/assets/images/muslim%20matrimon-01.png"
                      alt="Nikah Masnoon"
                    />
                  </Link>
                </Typography>
                    ...
                    {sessionStorage.getItem("token") ? (
                      <>
                        ...
                        >
                          <Avatar
                            size="sm"
                            className="border hidden md:block border-green-500 p-0.5"
                        ...
                        <div className="ml-4 flex-auto hidden md:block">
                          ...
                          <button
                            className="px-2 py-0 rounded-md text-center text-white bg-red-400 text-[12px] font-light"
                            onClick={() => {
                      ...
                      <>
                        <Link
                          color="black"
                          size="sm"
                          className="hidden lg:inline-block text-white bg-black  focus:ring-black-300 dark:focus:ring-black shadow-lg shadow-black/50 dark:shadow-lg dark:shadow-black/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
                          to="/login"
                        >
                          <span>Log In</span>
                        </Link>
                        <Link
                          color="green"
                          size="sm"
                          className="button hidden lg:inline-block text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
                          to="/register"
                        >
                          <span>Register</span>
                        </Link>
                ...
                {sessionStorage.getItem("token") ? (
                  <>
                    <button
                      ...
                      color="black"
                      size="sm"
                      className="bg-red-700 px-2 py-1 rounded text-lg font-semibold text-white"
                    >
                      <span>Log Out</span>
                    </button>
                  </>
                  ...
                  <>
                    <div className="flex items-center justify-between gap-x-1">
                      <NavLink
                        color="black"
                        size="sm"
                        className="bg-white px-2 py-1 rounded text-lg font-semibold text-green-500"
                        to="/login"
                      >
                        <span>Log In</span>
                      </NavLink>
        ...
        {sessionStorage.getItem("token") && (
          <div className="flex-wrap justify-center hidden md:flex bg-gray-900 shadow-2xl space-x-6">
            <Link
              to="/my-profile"
              className="flex items-center rounded-lg px-3 py-1 text-white transition ease-in-out delay-150 hover:bg-green-700 hover:-translate-y-1 hover:scale-60"
            >
              My Profile
            </Link>
            <Link
      ...
      {sessionStorage.getItem("token") && (
        <div className="fixed bottom-0 left-0 right-0 bg-green-100 p-3  flex md:hidden justify-center space-x-6 items-center z-[100]">
          <NavLink className="bg-green-300 p-2 rounded-full text-white" to="/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              height="30"
