  ...
  useEffect(() => {
    const fetchCities = async () => {
      if (selectedStateId) {
        setLoading(true);
        try {
          const response = await axios.get(`${URL}/api/cities/${selectedStateId}`, {
            headers: { Authorization: '1|MohDsaLeEmDIgitTalNawab|NikahMasnoon' },
          });
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="container mx-auto flex flex-col items-center justify-center h-full">
            <div className="rounded-md p-4 shadow-lg">
              ...
              <div className="rounded-full p-2 bg-white/50 w-full sm:w-auto">
                <div className="flex justify-center flex-col sm:flex-row items-center p-3 bg-white gap-2  rounded-full">
