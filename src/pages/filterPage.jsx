  ...
  const fetchUserData = async () => {
    ...
    try {
      const response = await axios.get(
        `${URL}/api/filter-user?userId=${userFilter}`,
        {
      ...
      setResults(response?.data?.data?.data || []);
      setTotalPages(1); // Assuming only one page for user search
    } catch (err) {
      console.error(err);
      ...
      <div className="bg-cover bg-gradient-to-tr from-yellow-50 via-indigo-50 to-amber-50 min-h-screen mt-24">
        <div className="container mx-auto p-4">
          <div className="grid grid-cols-12 mt-4 gap-6">
            {/* Filter Form */}
            <div className="col-span-10 lg:col-span-4 sticky top-20 self-start">
              <div className="lg:block hidden ">
                <Card className="p-6 bg-white shadow-lg">
                  <div className=" mb-4 ">
                    ...
                    {/* <button
                      className="w-full bg-green-600 rounded-xl text-white shadow shadow-green-300"
                      color="green"
                  ...
                  <form className="space-y-4">
                    {/* <input
                      className="w-full border border-gray-300 rounded-lg p-2"
                      onChange={(option) =>
                        handleFilterChange("userId", option.target.value)
                      }
                      placeholder="User Id"
                    /> */}
                    <Select
                    ...
                    <Select
                      ...
                      onChange={(option) =>
                        handleFilterChange("AnyDisability", option.value)
                      }
                    />
                    <Select
                    ...
                    <Select
                      ...
                      onChange={(option) =>
                        handleFilterChange("caste", option.value)
                      }
                    />
                    <Select
                      ...
                      onChange={(option) =>
                        handleFilterChange("familyType", option?.value || "")
                      }
                    />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <Select
                        ...
                        onChange={(option) =>
                          handleFilterChange("minHeight", option?.value || "")
                        } // Pass an empty string for "View All"
                      />
                      <Select
                        ...
                        onChange={(option) =>
                          handleFilterChange("maxHeight", option?.value || "")
                        } // Pass an empty string for "View All"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <Select
                        ...
                        onChange={(option) =>
                          handleFilterChange("minAge", option?.value || "")
                        }
                      />
                      <Select
                        placeholder="Max Age"
                        ...
                        onChange={(option) =>
                          handleFilterChange("maxAge", option?.value || "")
                        }
                      />
                    </div>
                    <Select
