          ...
          <div className=" w-full container mx-auto px-4 py-16">
              ...
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 pr-4">
                  <iframe
                    width="100%"
                    height="100%"
                    src="https://youtube.com/embed/kvr2qN8ZOMM?si=ZR0jRPxJSBgia3_6"
                  ...
                  {/* <iframe
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/y5Vl4-kzdIA?si=MeIrDPi0tdlUrkHq"
                ...
                <div className="md:w-1/2 pl-4">
                  ...
                  <Typography
                    color="gray"
                    className="mb-4 font-bold italic text-lg"
                  >
                    "The man dreams of a perfect woman and the woman dreams of a
                    perfect man and they don't know that Allah created them to
                    perfect one another."
                  </Typography>
                  <Typography color="gray" className="mb-4">
                    Marriage (Nikah) is considered as an act of worship
                    (Ibadat). It is a Social as well as a religious activity.
                    Islam advocates simplicity in ceremonies and celebrations.
                  </Typography>
                  <Typography color="gray" className="mb-4">
                    Prophet Muhammad considered 'Simple Wedding' as the best
                    'Wedding'
                  </Typography>
                  <Typography
                    color="gray"
                    className="mb-4 font-bold text-lg bg-green-100 p-4 rounded-lg"
                  >
                    نْكِحُوا الْأَيَامَىٰ مِنْكُمْ وَالصَّالِحِينَ مِنْ
                    عِبَادِكُمْ وَإِمَائِكُمْ ۚ إِنْ يَكُونُوا فُقَرَاءَ
                  ...
                  <Typography color="gray">
                    Nikah Masnoon is working on the new revolutionary concept
                    which will Save your time, decrease your expenses and
                    minimize your trouble.
                  </Typography>
                  <Typography color="gray">
                    Nikah masnoon has a authorized pan card issued by government
                    of india.
                  </Typography>
                </div>
              </div>
            ...
            <Card className="bg-gradient-to-r from-green-100 to-blue-100 p-6 rounded-lg shadow-md my-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                <div className="flex flex-col items-center bg-blue-50 p-6 rounded-lg shadow-md">
                  ...
                  <Typography color="gray" className="text-center">
                    Sign up and create a detailed profile highlighting your
                    background, interests, and preferences.
                  </Typography>
                </div>
                <div className="flex flex-col items-center bg-green-50 p-6 rounded-lg shadow-md">
                  ...
                  <Typography color="gray" className="text-center">
                    Our advanced algorithm suggests compatible matches based on
                    your criteria and preferences.
                  </Typography>
                </div>
                <div className="flex flex-col items-center bg-yellow-50 p-6 rounded-lg shadow-md">
                  ...
                  <Typography color="gray" className="text-center">
                    Communicate with potential matches through our secure
                    messaging system, adhering to Islamic guidelines.
                  </Typography>
                </div>
                <div className="flex flex-col items-center bg-red-50 p-6 rounded-lg shadow-md">
                  ...
                  <Typography color="gray" className="text-center">
                    Take the next step towards a blessed union with the support
                    of our community and resources.
                  </Typography>
                </div>
              </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="md:w-1/2 bg-white p-6 rounded-lg shadow-md">
                    ...
                    <ul className="list-disc list-inside text-gray-700">
                      <li>
                        Comprehensive website for profile registration and
                        searching
                      </li>
                      <li>
                        Dedicated helpdesks for assistance with profile
                        management
                      </li>
                  ...
                  <div className="md:w-1/2 bg-white p-6 rounded-lg shadow-md">
                    ...
                    <ul className="list-disc list-inside text-gray-700">
                      <li>
                        Personal consultants for face-to-face or phone
                        assistance
                      </li>
                ...
                >
                  Nikah Masnoon fulfills all your requirements and provides an
                  efficient system through our website, offline centres,
                  helpdesks, and dedicated consultants.
                </Typography>
              </div>
            </Card>
          </div>
