...
function allSuccessPartner() {
  ...
  useEffect(() => {
      const fetchSuccess = async () => {
          try {
              const response = await axios.get(`${URL}/api/success-partner`, {
                  headers: {
          ...
          <section className="flex bg-white-200 justify-center px-5 py-14">
              <div className="container">
                  <div className="text-center w-full">
                      ...
                      <div className="py-10">
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                              {success.slice(0, 8).map((success_partner, index) => (
...
export default allSuccessPartner
