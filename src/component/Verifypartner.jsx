...
function Verifypartner() {
  ...
  useEffect(() => {
    const fetchPartners = async () => {
      try {
        const response = await axios.get(`${URL}/api/verified-partner`, {
          headers: {
        ...
        <section className="flex justify-center bg-cover px-5 py-14 bg-gradient-to-tr hover:bg-gradient-to-l from-yellow-50 via-indigo-50 to-amber-50">
          <div className="container">
            <div className="text-center w-full">
              ...
              <p className="text-xl sm:text-1xl font-medium text-green-600 mt-1">
          ...
          <div className="text-center w-full">
            ...
            <div className="py-10">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {partners?.data?.map((partner) => {
                  ...
                  return (
                    <div
                      key={partner.id}
                      className="flex border border-green-100 w-full bg-gradient-to-r from-green-50 to-red-50 shadow-lg transition delay-150 duration-300 ease-in-out hover:shadow-2xl hover:border-green-500 hover:border-spacing-1 rounded-lg overflow-hidden"
                    >
                      <div className="relative w-2/5">
                        <img
                      ...
                      <div className="w-3/5 text-left p-3">
                        ...
                        >
                          ...
                          {calculateAge(partner.dob)}y |{" "}
                          <strong className="">{partner.marital_status}</strong>{" "}
                          | <strong className=""> {partner.city}</strong>
                        </Typography>
                        <Typography
                          color="gray"
                        ...
                        >
                          ...
                          {partner.caste}, {partner.sub_caste}
                        </Typography>
                        <div className="flex items-center mt-3">
                          <Link
                            to={`/user-details/${btoa(partner.id)}`}
              ...
              <div className="text-center mt-12">
                <Link
                  to="/all-verify-partner"
                  className="bg-green-600 text-white hover:bg-green-700 p-3 font-medium rounded"
                >
