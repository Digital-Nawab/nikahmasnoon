            ...
            <div className="py-10">
              <div className="grid  md:grid-cols-3  gap-10">
                {[...Array(9)].map((_, index) => (
                  ...
                  <Card
                    key={index}
                    className="mt-6 w-full overflow-hidden flex"
                  >
                    <CardHeader color="blue-gray" className="relative w-1/3">
                      <img
                        src={`https://nikahmasnoon.com/assets/user//202851710754109.jpeg`}
                        alt="Profile"
                    ...
                    <CardBody className="w-2/3 p-4">
                      ...
                      >
                        <FaFireAlt className="inline text-green-400 mr-1" /> 29y
                        | <strong className=""> Unmarried</strong>
                      </Typography>
                      <Typography
                        color="gray"
                      ...
                      <Typography
                        ...
                        className="font-semibold text-xs sm:text-sm"
                      >
                        <FaUser className="inline text-green-400 mr-1" />{" "}
                        Muslim, Pathan
                      </Typography>
                      <Typography
                        color="gray"
                        className="font-normal text-sm mt-2 sm:text-sm hidden md:block"
                      >
                        Seeking a life partner who values faith, kindness, and
                        mutual respect. Let's build a beautiful future together,
                        insha'Allah.
                      </Typography>
                    </CardBody>
                  </Card>
