...
function BasicInfo() {
  ...
  return (
    <form className="space-y-4" method="post" encType="multipart/form-data" onSubmit={handleUpdateBasicprofile}>
                ...
                <Select
                  ...
                  value={
                    profileData?.caste_preference ? {
                      ...
                      label: profileData.caste_preference === "any-caste" ? "Any Caste" :
                             profileData.caste_preference === "same-caste" ? "Same Caste" : 
                             "General Caste"
                    } : null
                  }
                  options={[
                  ...
                  <Select
                    ...
                    value={
                      profileData?.height ? {
                        ...
                        label: success?.Height?.find(h => h.title === profileData.height) 
                          ? `${success.Height.find(h => h.title === profileData.height).height_feet}ft ${success.Height.find(h => h.title === profileData.height).height_inches}in - ${success.Height.find(h => h.title === profileData.height).height_cm}cm`
                          : profileData.height
                      } : null
                    }
                    required
